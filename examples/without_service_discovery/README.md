...
| <a name="input_http_listeners"></a> [http\_listeners](#input\_http\_listeners) | A list of http listeners | <pre>list(object({<br>    port        = number<br>    protocol    = string<br>    target_port = number<br>    action_type = string<br>    redirect    = any<br>  }))</pre> | n/a | yes |
